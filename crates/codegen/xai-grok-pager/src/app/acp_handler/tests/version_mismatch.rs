#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn toast_157_150() -> String {
        crate::glyphs::sanitize_toast_message(
            "⚠ Version mismatch: client 0.1.157, leader 0.1.150. Restart Polycode to match",
        )
        .into_owned()
    }
    ...
    fn version_mismatch_toast_works_without_message_field() {
        ...
        let expected = crate::glyphs::sanitize_toast_message(
            "⚠ Version mismatch: client 0.2.1, leader 0.2.0. Restart Polycode to match",
        )
        .into_owned();
    ...
    fn version_mismatch_scrubs_control_chars_in_versions() {
        ...
        let expected = crate::glyphs::sanitize_toast_message(
            "⚠ Version mismatch: client 0.1.157  x, leader 0.1.150  . Restart Polycode to match",
        )
        .into_owned();
